...
class HabitValidationTest {
    ...
    @Test
    fun `Habit creation should succeed with valid INTERVAL hourly values`() {
    ...
    @Test
    fun `Habit creation should fail with extended invalid INTERVAL values`() {
        val invalidIntervalMinutes = listOf(7, 8, 9, 11, 13, 14, 16, 17, 18, 19, 21, 22)
